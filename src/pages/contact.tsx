    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center gap-7 py-20">
        ...
        <div className="mt-20 flex w-full flex-col gap-20">
          <div>
            <h2 className="block text-5xl font-semibold text-primary">Work</h2>
            <div className="container mt-2 flex overflow-hidden rounded-md border border-text/20">
              <div className="flex w-full flex-col divide-y divide-text/20">
                <strong className="bg-primary py-1 pl-5 text-background">
                  Type
                </strong>
              ...
              <div className="flex w-full flex-col divide-y divide-text/20">
                <strong className="bg-primary py-1 text-background">
                  Info
                </strong>
          ...
          <div>
            <h2 className="block text-5xl font-semibold text-primary">
              Social Media
            </h2>
            <div className="container mt-2 flex overflow-hidden rounded-md border border-text/20">
              <div className="flex w-full flex-col divide-y divide-text/20">
