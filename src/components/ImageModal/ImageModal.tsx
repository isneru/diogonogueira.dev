  ...
  return (
    <div className="fixed top-0 left-0 z-[9999] flex h-[100vh] w-[100vw] items-center justify-center bg-black/75">
      <div className="relative flex h-[80vh] w-[80vw] items-center justify-center gap-2">
        <button
          className="hidden h-full items-center justify-center rounded bg-primary px-3 text-background outline-none hover:bg-primary lg:flex lg:px-6"
        ...
        <button
          className="absolute -top-10 left-1/2 flex -translate-x-1/2 items-center justify-center rounded-md bg-primary px-2 py-1 text-background hover:ring-2 hover:ring-primary"
          onClick={() => setClickedImg(undefined)}>
          Close Preview
        </button>
      </div>
